...
//                Block myBlock = new Block(new Rectangle(new Point(10 + i * 80, 10 + j * 60), 20, 20), java.awt.Color.BLACK, ge);
//                blocks.add(myBlock);
//                ge.addCollidable(myBlock);
//            }
//        }
//        Block rightSideOfScreen = new Block(new Rectangle(new Point(width, 0), width, height), java.awt.Color.BLACK, ge);
//        Block leftSideOfScreen = new Block(new Rectangle(new Point(-width, 0), new Point(0, height)), java.awt.Color.BLACK, ge);
//        Block topSideOfScreen = new Block(new Rectangle(new Point(0, -height), new Point(width, 0)), java.awt.Color.BLACK, ge);
//        Block bottomSideOfScreen = new Block(new Rectangle(new Point(0, height), new Point(width, 2*height)), java.awt.Color.BLACK, ge);
